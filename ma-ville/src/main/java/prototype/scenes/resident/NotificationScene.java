                ...
                public void onSuccessReturn(ArrayList<Notification> notifications) {
                    Platform.runLater(() -> {
                        ...
                        for (Notification notification : notifications) {
                            ...
                            System.out.println("selected quartiers : "+ selectedQuartiers);

//                            System.out.println("Is a"+selectedQuartiers != null && selectedQuartiers.stream()
//                                    .anyMatch(q -> q.equalsIgnoreCase(notificationQuartier)));
                        ...
                        Text notificationCountText = new Text("Notifications: " + notificationCount);

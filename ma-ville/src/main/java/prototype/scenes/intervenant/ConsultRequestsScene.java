...
public class ConsultRequestsScene extends Scenes {
    ...
    public ConsultRequestsScene(SceneController sceneController, RequestController requestController) {
    ...
    public void setScene() {
        ...
        this.requestsList = this.requestController.getRequests();
    ...
    private void updateRequestDisplay() {
        ...
        Platform.runLater(() -> {
            ...
            for (Request request : filteredRequests) {
                VBox box = new VBox();
                box.getChildren().add(request.afficher());
                ...
                candidature.setOnMouseClicked(event -> {
                    ...
                    soumettre.setOnMouseClicked(e -> {
                        requestController.addProject();
                    });

                    box.getChildren().addAll(startDate, endDate, soumettre);
                });

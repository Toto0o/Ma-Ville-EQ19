...
public class RequestController {
    ...
    public void addProject(String title, Type type, String description, String quartier, String startDate, String endDate) {
        Project project = new Project(title, type, description, quartier, startDate, endDate, (Intervenant) this.userController.getUser());

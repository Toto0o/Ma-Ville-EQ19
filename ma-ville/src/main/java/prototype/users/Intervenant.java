...
public class Intervenant extends Utilisateur {
    ...
    public Intervenant(String name, String lastname, String password, String birthday, String phone, String email, Address address, String cityID, IntervenantType type) {
